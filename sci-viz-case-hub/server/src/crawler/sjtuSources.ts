...
export const SJTU_COLLEGE_SOURCES: SJTUSourceConfig[] = [
  ...
  // ===== 国家级科研平台（从交大国家级科研平台一览页提取）=====
  {
    name: '机械系统与振动全国重点实验室',
    url: 'https://msv.sjtu.edu.cn',
    sourceType: 'national_lab_news',
    category: 'SJTU-NATLAB',
    crawlTier: 'A',
    crawlStatus: 'active_static',
    adapterType: 'static_html',
    visualValue: '科研成果配图、学术会议照片、CCTV新闻联播报道视频、实验平台照片、获奖证书',
    strategyHint: '新闻资讯/学术报告/通知公告栏目有科研图文配图，有央视报道视频；有Nature Communications等顶刊论文配图',
    notes: '机械/振动/动力学；全国重点实验室',
  },
  {
    name: '海洋工程全国重点实验室',
    ...
    crawlStatus: 'active_static',
    adapterType: 'static_html',
    visualValue: '船模试验照片、海洋装备图、数值仿真可视化、实验设施照片',
    strategyHint: '科研要闻/媒体视角/合作交流栏目；有基准实验/数值实验/科研设施等可视化内容',
    notes: '船舶/海洋工程；全国重点实验室',
  },
  {
    name: '光子传输与通信全国重点实验室',
    url: 'https://loct.sjtu.edu.cn',
    sourceType: 'national_lab_news',
    category: 'SJTU-NATLAB',
    crawlTier: 'A',
    crawlStatus: 'active_static',
    adapterType: 'static_html',
    visualValue: '学术报告照片、科研成果配图（OFC等顶会）、实验室照片、光纤通信可视化',
    strategyHint: '新闻资讯栏目有OFC等国际顶会成果报道；交换学术报告栏目有配图',
    notes: '光通信/光子学；全国重点实验室',
  },
  {
    name: '微生物代谢全国重点实验室',
    url: 'https://skmml.sjtu.edu.cn',
    sourceType: 'national_lab_news',
    category: 'SJTU-NATLAB',
    crawlTier: 'A',
    crawlStatus: 'active_static',
    adapterType: 'static_html',
    visualValue: '科研成果配图、学术交流照片（国际代表团访问）、实验室设备照片、科普活动照片',
